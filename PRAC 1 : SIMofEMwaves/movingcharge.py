...
mpl.use('Agg')  # Use the 'Agg' backend for non-interactive environments
...
ani = FuncAnimation(fig, update_animation,
                    frames=n_frames, blit=False, init_func=init_animate)

# Save the animation as a gif file
ani.save('oscillating_charge.gif',
         writer=animation.PillowWriter(fps=10), dpi=200)
